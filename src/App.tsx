...
const TdvConversionBackdrop = () => (
  <>
    ...
    />
    <div className="absolute -left-24 -top-28 h-[520px] w-[520px] rounded-full bg-transparent" />
    <div className="absolute -bottom-32 -right-20 h-[520px] w-[520px] rounded-full bg-transparent" />
              ...
              >
                ...
                <div>
                  <span className="font-extrabold text-lg tracking-tight text-white block">
                    <span className="text-slate-400">TD | </span><span className="!text-[#D4FF00]">V</span><span className="text-white">entures</span>
                  </span>
